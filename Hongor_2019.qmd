...
Рассмотрим модели типа "\~ grf9_6a_12del \* vrna1 \* место" для всех наблюдаемых параметров для grf9_6a_12del на уровнях 0 и 2.
...
ggplot(main_table, aes(x=!!sym(x))) + 
  ...
  facet_grid(grf9_6a_12del +  vrna1  ~ место, labeller = label_parsed, 
...
anova <- aov(as.formula(glue::glue("{x} ~ grf9_6a_12del *  vrna1  * место")), data = main_table)

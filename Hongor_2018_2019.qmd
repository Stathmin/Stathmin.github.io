...
Рассмотрим модели типа "\~ grf9_6a_12del \* ddw1 \* vrna1 \* место \* год" для всех наблюдаемых параметров для grf9_6a_12del на уровнях 0 и 2.
...
anova <- aov(as.formula(glue::glue("{x} ~ grf9_6a_12del * ddw1 * vrna1 * место * год")), data = main_table)
